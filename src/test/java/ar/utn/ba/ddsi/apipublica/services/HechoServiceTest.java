...
class HechoServiceTest {
    ...
    void buscarConFiltroDelegatesParsedValuesToRepository() {
        ...
        List<Hecho> result = hechoService.buscarConFiltro(filter);
    ...
    void buscarConFiltroSinParametrosRecuperaTodo() {
        ...
        List<Hecho> result = hechoService.buscarConFiltro(null);
    ...
    void buscarConFiltroLanzaExcepcionPorFechaInvalida() {
        ...
        verify(hechoRepository, times(0)).buscarHechosSegun(any(), any(), any(), any(), any(), any(), any(), any());
    }
}
